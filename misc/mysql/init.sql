...
CREATE TABLE IF NOT EXISTS `DirectorioParticipante`.`organisation` (
  ...
  `requires_participants_terms_and_conditions_signing` TINYINT NULL,
...
-- -----------------------------------------------------
-- Table `DirectorioParticipante`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DirectorioParticipante`.`user` (
  `user_id` VARCHAR(40) NOT NULL,
  `organisation_id` VARCHAR(40) NOT NULL,
  `first_name` VARCHAR(255) NULL,
  `last_name` VARCHAR(255) NULL,
  `email_address` VARCHAR(255) NULL,
  `phone_country` VARCHAR(2555) NULL,
  `phone_number` VARCHAR(18) NULL,
  ...
  INDEX `fk_contacts_Organisations1_idx` (`organisation_id` ASC) VISIBLE,
  CONSTRAINT `fk_contacts_Organisations10`
    FOREIGN KEY (`organisation_id`)
    REFERENCES `DirectorioParticipante`.`organisation` (`organisation_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
