...
-- -----------------------------------------------------
-- Table `mydb`.`authorisation_servers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`authorisation_servers` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`contacts` (
  ...
  `country` VARCHAR(255) NULL,
  `status` VARCHAR(45) NULL,
  `additional_information` VARCHAR(65535) NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`api_resources`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`api_resources` (
  ...
  CONSTRAINT `fk_api_resources_1`
    ...
    REFERENCES `mydb`.`authorisation_servers` (`authorisation_server_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`api_discovery-endpoints`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`api_discovery-endpoints` (
  ...
  CONSTRAINT `fk_api_discovery-endpoints_1`
    ...
    REFERENCES `mydb`.`api_resources` (`api_resource_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`organisation_admin_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`organisation_admin_user` (
  `organisation_id` INT NULL,
  `org_admin_user_id` INT NOT NULL,
  `user_mail` VARCHAR(45) NULL,
  `status` VARCHAR(45) NULL,
  `Organisations_organisation_id` INT NOT NULL,
  PRIMARY KEY (`org_admin_user_id`, `Organisations_organisation_id`),
  INDEX `fk_organisation_admin_user_Organisations1_idx` (`Organisations_organisation_id` ASC) VISIBLE,
  CONSTRAINT `fk_organisation_admin_user_Organisations1`
...
-- -----------------------------------------------------
-- Table `mydb`.`organisations_terms_and_conditions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`organisations_terms_and_conditions` (
  ...
  `status` VARCHAR(45) NULL,
  `organisation_id` VARCHAR(40) NOT NULL,
  PRIMARY KEY (`organisation_id`, `organisation_id`),
  INDEX `fk_organisations_terms_and_conditions_Organisations1_idx` (`organisation_id` ASC) VISIBLE,
  CONSTRAINT `fk_organisations_terms_and_conditions_Organisations1`
    FOREIGN KEY (`organisation_id`)
    REFERENCES `mydb`.`organisation` (`organisation_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `mydb`.`enumstatus`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`enumstatus` (
...
-- -----------------------------------------------------
-- Table `mydb`.`organisation_authority_domain_claims`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`organisation_authority_domain_claims` (
  ...
  CONSTRAINT `fk_organisation_authority_domain_claims_1`
    FOREIGN KEY (`status`)
    REFERENCES `mydb`.`enumstatus` (`campo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`organisation_authority_domain_role_claims`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`organisation_authority_domain_role_claims` (
  `Organisation_id` VARCHAR(40) NOT NULL,
  ...
  `Organisations_organisation_id` VARCHAR(40) NOT NULL,
  PRIMARY KEY (`Organisation_id`, `Organisations_organisation_id`, `authority_id`, `status`),
  INDEX `fk_organisation_authority_domain_role_claims_Organisations1_idx` (`Organisations_organisation_id` ASC) VISIBLE,
  INDEX `fk_organisation_authority_domain_role_claims_1_idx` (`authority_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_organisation_authority_domain_role_claims_Organisations1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_organisation_authority_domain_role_claims_1`
    FOREIGN KEY (`authority_id`)
    REFERENCES `mydb`.`organisation_authority_domain_claims` (`organisation_authority_domain_claim_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mydb`.`organisation_certificate`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`organisation_certificate` (
  `organisation_id` VARCHAR(40) NOT NULL,
  `reference_id` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`authorisation_server_certifications`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`authorisation_server_certifications` (
...
-- -----------------------------------------------------
-- Table `mydb`.`software_statements`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`software_statements` (
...
-- -----------------------------------------------------
-- Table `mydb`.`software_statements_certifications`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`software_statements_certifications` (
  `certification_id` VARCHAR(40) NOT NULL,
  `ref_certification_id` VARCHAR(45) NULL,
  `profile_variant` VARCHAR(45) NULL,
  `profile_version` VARCHAR(45) NULL,
  ...
  CONSTRAINT `fk_software_statements_certifications_1`
    ...
    REFERENCES `mydb`.`software_statements` (`software_statement_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mydb`.`software_statement_domain_authority_roles_claims`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`software_statement_domain_authority_roles_claims` (
...
-- -----------------------------------------------------
-- Table `mydb`.`software_statements_certificate`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`software_statements_certificate` (
